...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Feb 25 22:56:09 2016
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) gen_objs/raspberrypi_video1.0.0/ && $(COPY_FILE) --parents ControlThread.h Lepton_I2C.h LeptonThread.h MyLabel.h Palettes.h PiCamThread.h gen_objs/raspberrypi_video1.0.0/ && $(COPY_FILE) --parents ControlThread.cpp Lepton_I2C.cpp LeptonThread.cpp main.cpp MyLabel.cpp Palettes.cpp PiCamThread.cpp gen_objs/raspberrypi_video1.0.0/ && (cd `dirname gen_objs/raspberrypi_video1.0.0` && $(TAR) raspberrypi_video1.0.0.tar raspberrypi_video1.0.0 && $(COMPRESS) raspberrypi_video1.0.0.tar) && $(MOVE) `dirname gen_objs/raspberrypi_video1.0.0`/raspberrypi_video1.0.0.tar.gz . && $(DEL_FILE) -r gen_objs/raspberrypi_video1.0.0
